    ...
    ColumnLayout {
        ...
        ScrollView {
            ...
            Text {
                ...
                text: qsTr("<h2>游戏规则</h2>" + "<p>1. 点击两个相同的方块</p>" + "<p>2. 如果两个方块可以用不超过三条直线连接，它们就会消失</p>" + "<p>3. 消除所有方块即可获胜</p>" + "<p>4. 游戏有时间限制，请在时间内完成</p>" + "<h2>操作说明</h2>" + "<p>- 点击方块选择</p>" + "<p>- 再次点击取消选择</p>" + "<p>- 点击'提示'按钮获取帮助</p>" + "<p>- 游戏结束后可以查看得分</p>" + "<h2>快捷键</h2>" + "<p>- ESC：暂停游戏/返回</p>" + "<p>- 方向键：移动选择</p>" + "<p>- 空格键：选择方块</p>" + "<h2>作者</h2>" + "<p>- 潘彦玮</p>" + "<p>- 谢智行</p>")
