...
QtObject {
    ...
    function loadTheme(themeName) {
        ...
        switch (themeName) {
        case light_theme:
            component = Qt.createComponent("theme/LightTheme.qml");
            break;
        case dark_theme:
            component = Qt.createComponent("theme/DarkTheme.qml");
            break;
        case pink_theme:
            component = Qt.createComponent("theme/PinkTheme.qml");
            break;
        default:
            component = Qt.createComponent("theme/LightTheme.qml");
            break;
        ...
        if (component.status === Component.Ready) {
            ...
            console.error("加载主题失败:", component.errorString());
            // 尝试加载默认主题
            component = Qt.createComponent("theme/LightTheme.qml");
            if (component.status === Component.Ready) {
                currentTheme = component.createObject();
